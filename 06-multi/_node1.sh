...
echo ""
echo "> namespace"
pe "ip netns add pod1"

echo ""
echo "> bridge"
pe "ip link add br0 type bridge"
pei "ip addr add 10.1.1.1/24 dev br0"
pei "ip link set br0 up"

echo ""
echo "> veth"
pe "ip link add veth-host type veth peer name veth-ns"

echo ""
echo "> move veth-ns to the pod namespace"
pe "ip link set veth-ns netns pod1"

echo ""
echo "> attach host veth to bridge"
pe "ip link set veth-host master br0"
