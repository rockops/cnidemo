...
Establish connectivity between two independent namespaces (`ns1` at `10.0.0.2` and `ns2` at `10.0.0.3`) by binding their host-side `veth` interfaces to a common software bridge (`br0`) acting as a Layer 2 switch.
