...
pei "sudo ip addr add 10.0.0.154/24 dev br0"
pei "sudo ip link set br0 up"

comment "The bridge is now created and its IP is 10.0.0.154" "Before attaching the 2 host_veth to the bridge, we need to unassign their IP" "In a real CNI plugin, the veth_host are creatred without an IP"
